...
### Core
- [x] IMAP IDLE + exponential backoff reconnect
- [x] SMTP sender (port 465 implicit TLS)
...
- [x] Thread context in notification email (up to 5 ancestors)
...
- [x] Comprehensive agent docs in `docs/` (12 modules)

## v0.2 — Short term

### Security
- [ ] Attachment scanning / validation
- [ ] Rate limiting on IMAP/SMTP
